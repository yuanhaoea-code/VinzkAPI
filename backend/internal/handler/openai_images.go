...
func (h *OpenAIGatewayHandler) Images(c *gin.Context) {
	...
	if !service.GroupAllowsImageTier(apiKey.Group, parsed.SizeTier) {
		h.errorResponse(c, http.StatusForbidden, "permission_error", service.ImageTierPermissionMessage())
		return
	}
