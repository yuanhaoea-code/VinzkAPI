...
const apiKeyAuthSnapshotVersion = 14 // v14: include group image resolution tiers
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ImageAllowedTiers:               NormalizeImageAllowedTiers(apiKey.Group.ImageAllowedTiers, apiKey.Group.AllowImageGeneration),
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ImageAllowedTiers:               NormalizeImageAllowedTiers(snapshot.Group.ImageAllowedTiers, snapshot.Group.AllowImageGeneration),
