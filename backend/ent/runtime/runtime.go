...
func init() {
	...
	// groupDescImageAllowedTiers is the schema descriptor for image_allowed_tiers field.
	groupDescImageAllowedTiers := groupFields[16].Descriptor()
	// group.DefaultImageAllowedTiers holds the default value on creation for the image_allowed_tiers field.
	group.DefaultImageAllowedTiers = groupDescImageAllowedTiers.Default.([]string)
